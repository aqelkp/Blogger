...
public class BloggerCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        Log.d("blogger", cursor.getString(cursor.getColumnIndex(cursor.getColumnName(1))));
        ...
        Log.d("loaded or not", Integer.toString( cursor.getInt(cursor.getColumnIndex(cursor.getColumnName(11)))));
